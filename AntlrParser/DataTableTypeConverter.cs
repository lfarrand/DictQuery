...
namespace AntlrParser
{
    public static class DataTableTypeConverter
    {
        public static bool AreEqual(object left, object right)
        {
            ...
            {
                double d1 = Convert.ToDouble(left, CultureInfo.InvariantCulture);
                double d2 = Convert.ToDouble(right, CultureInfo.InvariantCulture);
        ...
        public static int CompareValues(object left, object right)
        {
            ...
            if (IsNumeric(left) && IsNumeric(right))
            {
                double d1 = Convert.ToDouble(left);
                double d2 = Convert.ToDouble(right);
